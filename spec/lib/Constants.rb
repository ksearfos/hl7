module HL7
  ...
  # lists of all possible values for various fields
  ...
  # maps identifying the name of a field and its index 
  MSH_FIELDS = { sending_application: 2, sending_facility: 3, receiving_application: 4,
                 receiving_facility: 5, date_time: 6, security: 7, message_type: 8, event: 8,
  ...
  PID_FIELDS = { set_id: 1, patient_id: 3, mrn: 3, patient_name: 5, mothers_maiden_name: 6,
                 dob: 7, sex: 8, race: 10, address: 11, country_code: 12, home_phone: 13,
                 business_phone: 14, language: 15, marital_status: 16, religion: 17,
                 account_number: 18, ssn: 19, drivers_license_number: 20, ethnic_group: 22,
                 birthplace: 23, citizenship: 26, military_status: 27, nationality: 28,
                 death_date_time: 29 }
  ...
  PV1_FIELDS = { set_id: 1, patient_class: 2, patient_location: 3, admission_type: 4,
                 attending_doctor: 7, attending: 7, referring_doctor: 8, referring: 8,
                 consulting_doctor: 9, consulting: 9, hospital_service: 10, admit_source: 14,
                 admitting_doctor: 17, admitting: 17, patient_type: 18, visit_number: 19,
                 financial_class: 20, diet_type: 38, bed_status: 40, admit_date_time: 44,
                 discharge_date_time: 45, current_balance: 46, total_charges: 47, total_payments: 49,
                 visit_indicator: 51, discharge_disposition: 36 }
  ...
  OBR_FIELDS = { set_id: 1, place_order_number: 2, filler_order_number: 3, control_code: 3,
                 accession_number: 3, service_id: 4, procedure_id: 4, priority: 5, observation_date_time: 7,
